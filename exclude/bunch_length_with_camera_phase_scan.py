...
#        print type(self.magnetlist)
    ...
    def saveSettings(self,settings_filename):
        ...
        self.settings_dictionary['L00crest']=int(self.L00PhaseCrest.text())
        self.settings_dictionary['L01crest']=int(self.L01PhaseCrest.text())
        self.settings_dictionary['L02crest']=int(self.L02PhaseCrest.text())
    ...
    def updateImage(self):
        ...
        mu,std = norm.fit(self.imgLineout)        
    ...
    def myLayout(self):        
        ...
        self.cameraStopButton = QtGui.QPushButton("stop camera",self.cameraBox)
    ...
    def saveImages(self):
        ...
        for i in range(self.noImagesBox.value()):
            ...
            filename = ''.join((self.imgfoldername,'/',imgname,'_','img',str(i+1),'_', time.strftime('%Y-%m-%d_%Hh%M'), '.tiff'))
